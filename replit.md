...
تسعيرة منصة عربية لحساب الأسعار في سبعة قطاعات: الخدمات، الباقات والاشتراكات، المطاعم والكافيهات، التجزئة والجملة، المشاريع التقنية، الشركات التقنية، والتصميم الداخلي والمعماري. تشمل المنصة أيضاً الحسابات والعملاء والرسائل وحفظ النتائج كعروض عند الحاجة.
...
- `pages/landing.php` — الصفحة العامة والتعريف بالقطاعات والأدوات
- `pages/dashboard.php` — لوحة العمل ومركز أدوات التسعير والنتائج
- `router.php` — نقطة تشغيل آمنة للواجهة والملفات الثابتة
- `api/index.php` — حد API للجلسات، فحص الصحة، الدخول، التسجيل، ورسائل التواصل
- `legacy-calculator.html` — نسخة احتياطية من أدوات التسعير السابقة
...
المنصة تعمل حالياً بوضع وصول مفتوح مؤقت (`OPEN_ACCESS_MODE`)؛ جميع أدوات وحاسبات التسعير متاحة مجاناً ولا تظهر باقات الاشتراك للمستخدمين. يمكن تعطيل الوضع لاحقاً من `config.php` بعد انتهاء فترة التحقق مع العميل.
