...
$toolMap = [
    'services' => [
        ...
        'image' => '/assets/landing/sector-services-icon-transparent.png',
        'icon' => '/assets/landing/sector-services-icon-transparent.png',
        'plan' => 'calc_basic',
    ],
    'packages' => [
        'legacy' => 'packages',
        ...
        'image' => '/assets/landing/empty-box-transparent.png',
        'icon' => '/assets/landing/empty-box-transparent.png',
        'plan' => 'calc_pkg',
    ],
    'menu' => [
        'legacy' => 'menu',
        ...
        'image' => '/assets/landing/sector-restaurants-icon-transparent.png',
        'icon' => '/assets/landing/sector-restaurants-icon-transparent.png',
        'plan' => 'calc_menu',
    ],
    'retail' => [
        'legacy' => 'retail',
        ...
        'image' => '/assets/landing/sector-retail-icon-transparent.png',
        'icon' => '/assets/landing/sector-retail-icon-transparent.png',
        'plan' => 'calc_store',
    ],
    'tech' => [
        'legacy' => 'tech',
        ...
        'image' => '/assets/landing/sector-technology-icon-transparent.png',
        'icon' => '/assets/landing/sector-technology-icon-transparent.png',
        'plan' => 'calc_labor',
    ],
    'saas' => [
        'legacy' => 'saas',
    ...
    'design' => [
        ...
        'image' => '/assets/landing/sector-design-icon-transparent.png',
        'icon' => '/assets/landing/sector-design-icon-transparent.png',
        'plan' => 'calc_office',
    ],
];
